...
// TODO: (Ted)  Change this so 100 is no hard-coded as the max supported
//              textures.
fragment float4
fragmentShader(RasterizerData in [[stage_in]],
               array<texture2d<half>, 100> texture_array [[ texture(0) ]]) 
{

    texture2d<half> colorTexture = texture_array[in.textureID];

    // NOTE: (Ted)  This is the kind of texture sampler guaranteed to give us that
    //              Pixel Art style.
