...
xcrun -sdk macosx metal -c "${MAC_PLATFORM_LAYER_PATH}/ColorShaders.metal" -o ColorShaders.air
...
echo Compiling Texture Packer Mac Platform Layer
clang -g -lstdc++ ${COMMON_COMPILER_FLAGS} -o $APP_NAME "${MAC_PLATFORM_LAYER_PATH}/mac_os_main.mm"
